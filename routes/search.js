...
// Odesa Region
router.get('/bilgorod-dnistrovsky/search', SearchController.searchBilgorodDnistrovkyNews)
router.get('/chornomorsk/search', SearchController.searchChornomorskNews)
router.get('/izmail/search', SearchController.searchIzmailNews)
